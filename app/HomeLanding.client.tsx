...
export function HomeLanding() {
  ...
  return (
    <div className="relative min-w-0 w-full overflow-x-hidden text-white bg-[#050505]">
        ...
        <div className="relative z-[10] page-shell flex w-full flex-1 flex-col pb-16 pt-24 md:pb-20 md:pt-32 lg:pt-36 xl:pt-40">
          <div className="flex shrink-0 justify-center md:justify-end">
            <div className="flex w-full max-w-none flex-col items-center text-center md:items-end md:text-right">
              ...
              <motion.h1
                id="home-hero-title"
                className="font-optimus mt-4 max-w-[min(100%,22rem)] text-balance text-2xl font-normal uppercase leading-[1.08] tracking-[0.06em] text-white [text-shadow:0_0_14px_rgba(0,0,0,0.82),0_0_42px_rgba(75,42,12,0.38),0_0_88px_rgba(42,22,8,0.22)] sm:max-w-none sm:text-3xl sm:whitespace-nowrap sm:leading-[1] md:text-4xl lg:text-5xl xl:text-6xl"
                initial={reduce ? false : { opacity: 0 }}
                animate={reduce ? false : { opacity: 1 }}
                transition={{
                ...
                <div className="max-w-2xl">
                  ...
                  <div className="mt-8 space-y-6 font-lore leading-[1.6] text-[#e0e0d8] antialiased md:mt-10">
                    <p className="text-[1.1rem] normal-case tracking-tight md:text-[1.25rem] [text-shadow:1px_1px_2px_rgba(0,0,0,0.8)]">
                      To traverse the lands of the old gods is to walk upon the ashes of those who
                      came before. Soulspedia is a definitive archive dedicated to the Dark Souls trilogy,
                      preserving the legacy of every soul that has flickered across Lordran, Drangleic,
                      and Lothric.
                    </p>
                    <p className="text-[1.1rem] normal-case tracking-tight md:text-[1.25rem] [text-shadow:1px_1px_2px_rgba(0,0,0,0.8)]">
                      From the deified Lords of Cinder who bound the First Flame to the hollowed
                      outcasts forgotten by time, we chronicle every tragic pilgrimage. Our mission is
                      to transcribe these fading echoes into an eternal record, ensuring that even in the
                      coming age of dark, their fates are never truly lost to the abyss.
                    </p>
                  </div>
      ...
      {/* Solo fondo (contenido «Echoes» retirado); id `#figures` se mantiene por enlaces externos o anclas */}
      <section
        id="figures"
