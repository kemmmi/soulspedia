...
export const metadata: Metadata = {
  title: "New Thread — Dark Souls | Soulspedia",
  description: "Open a new discussion thread in the Dark Souls forum.",
};
...
export default function DarkSoulsForumNewPage() {
  return (
