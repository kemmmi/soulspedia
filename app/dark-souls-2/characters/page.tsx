...
export const metadata: Metadata = {
  title: "Characters — Dark Souls II | Soulspedia",
  description:
    "Key figures in Dark Souls II: Vendrick, Nashandra, Aldia, and the Emerald Herald.",
};
...
export default function DarkSouls2CharactersPage() {
  return (
    <div className="relative flex min-h-0 flex-1 flex-col overflow-hidden bg-black">
      <div className="page-shell relative z-10 flex w-full min-w-0 flex-1 flex-col items-center pb-12 pt-6 md:pb-16 md:pt-8">
        ...
        <header className="mb-10 flex w-full max-w-5xl flex-col items-center text-center md:mb-12 lg:max-w-6xl">
          ...
          >
            Drangleic&apos;s crown, the curse of want, and those who shape your
            road to the throne — add images to each tile when ready.
          </p>
        </header>

        <section
          className="w-full max-w-6xl lg:max-w-7xl"
          aria-label="Lore — Drangleic figures"
        >
