...
export const metadata: Metadata = {
  title: "New Thread — Dark Souls II | Soulspedia",
  description: "Open a new discussion thread in the Dark Souls II forum.",
};
...
export default function DarkSouls2ForumNewPage() {
  return (
